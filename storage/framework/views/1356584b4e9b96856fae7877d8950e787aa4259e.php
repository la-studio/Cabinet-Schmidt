...
<html>
	...
	<body>
		<p>Cliquez ici pour réinitialiser votre mot de passe : <a href="<?php echo e($link = url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset())); ?>"> <?php echo e($link); ?> </a><p>
		<br>
