          ...
          <h3 class="actus-articles__header">L'actualité des TPE-PME</h3>
           <?php for($i = 0; $i < 2; $i++): ?>
            <article class="row article">
              <a href="/actus/<?php echo e($echosarticles[$i]->slug); ?>" class="col-xs article__picture" style="background-image: url('<?php echo e($echosarticles[$i]->image); ?>')"></a>
              <div class="col-xs article__content">
                <div class="row article__wrapper">
                  <h4 class="article__name <?php if($is_large): ?>article__name--small"<?php endif; ?>><a href="/actus/<?php echo e($echosarticles[$i]->slug); ?>"><?php echo e($echosarticles[$i]->title); ?></a></h4>
                  <p class="article__body">
