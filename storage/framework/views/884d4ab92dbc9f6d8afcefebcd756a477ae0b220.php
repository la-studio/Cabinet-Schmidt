        ...
        <?php if(isset($result)): ?>
          ...
          <div class="col-md col-sm-6 col-xs-12 suggestion">
            <div class="row wrapper">
              <span class="col-xs-12 suggestion__cover"><a href="/chiffres-utiles/<?php echo e($suggestion->slug); ?>" rel="nofollow" style="background-image:url('<?php echo e($suggestion->image); ?>')"></a></span>
              <a href="/chiffres-utiles/<?php echo e($suggestion->slug); ?>" class="col-xs-12 suggestion__caption" rel="nofollow"><?php echo e($suggestion->title); ?></a>
            </div>
          </div>
          <?php endforeach; ?>
        <?php endif; ?>
