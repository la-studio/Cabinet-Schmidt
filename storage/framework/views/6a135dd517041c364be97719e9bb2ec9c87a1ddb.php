      ...
      <div class="col-custom admin-menu">
        ...
        <nav class="row admin-menu__nav">
          <ul class="col-xs admin-menu__list">
            <li class="row admin-menu__item">Articles</li>
            <li class="row admin-menu__item">Témoignages</li>
            <li class="row admin-menu__item">Partenaires</li>
            <li class="row admin-menu__item">Slider</li>
          </ul>
        </nav>
      </div>
