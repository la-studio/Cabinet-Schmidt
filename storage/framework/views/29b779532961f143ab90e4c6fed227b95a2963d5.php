        ...
        <div class="col-xs">
          <div class="row center-xs partenaire__field">
            <div class="col-md-8 col-sm-10 col-xs-12">
              ...
              <input class="large-field" type="text" name="title" value="<?php echo e($competence->title); ?>">
            </div>
          </div>
          <div class="row center-xs partenaire__field">
            <div class="col-md-8 col-sm-10 col-xs-12">
              <span>Slogan</span>
              <input class="large-field" type="text" name="label" value="<?php echo e($competence->label); ?>">
            </div>
          </div>
          <div class="row center-xs partenaire__field">
            <div class="col-md-8 col-sm-10 col-xs-12">
              <span>Description</span>
              <textarea id="cabinet-article" class="large-field text-field" name="description"><?php echo e($competence->description); ?></textarea>
            </div>
          </div>
