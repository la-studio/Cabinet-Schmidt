                          ...
                          <ul class="nav navbar-nav" id="nav-buttons">
                            ...
                            <li>
                              <a href="#" id="add-folder">
                                <i class="fa fa-plus"></i> <?php echo e(Lang::get('laravel-filemanager::lfm.nav-new')); ?>

                              </a>
                            </li>
                            <li>
                              <a href="#" id="upload" data-toggle="modal" data-target="#uploadModal">
                                <i class="fa fa-upload"></i> <?php echo e(Lang::get('laravel-filemanager::lfm.nav-upload')); ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo e(route('unisharp.lfm.upload')); ?>" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data'>
            ...
            <input type='hidden' name='show_list' id='show_list' value='<?php echo e(($startup_view == 'list') ? 1 : 0); ?>'>
