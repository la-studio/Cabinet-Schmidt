...
<div class="row center-xs chiffres">
  ...
  <div class="col-md-10 col-xs-12 gallery" id="gallery">
    <ul class="row center-xs filters">
      <li class="col-lg-2 col-md-2 col-sm-4 col-xs-6 filters__item <?php echo e(($page == 'digit') ? 'filters__item--checked' : ''); ?>" data-filter="all"><a href="<?php echo e(URL::to('chiffres-utiles#gallery')); ?>" rel="nofollow"><span>Tous</span></a></li>
      <li class="col-lg-2 col-md-2 col-sm-4 col-xs-6 filters__item <?php echo e(($page == 'Social') ? 'filters__item--checked' : ''); ?>" data-filter="Social"><a href="<?php echo e(URL::to('chiffres-utiles/rubrique/Social#gallery')); ?>" rel="nofollow"><span>Social</span></a></li>
      <li class="col-lg-2 col-md-2 col-sm-4 col-xs-6 filters__item <?php echo e(($page == 'Fiscal') ? 'filters__item--checked' : ''); ?>" data-filter="Fiscal"><a href="<?php echo e(URL::to('chiffres-utiles/rubrique/Fiscal#gallery')); ?>" rel="nofollow"><span>Fiscal</span></a></li>
      <li class="col-lg-2 col-md-2 col-sm-4 col-xs-6 filters__item <?php echo e(($page == 'Juridique') ? 'filters__item--checked' : ''); ?>" data-filter="Juridique"><a href="<?php echo e(URL::to('chiffres-utiles/rubrique/Juridique#gallery')); ?>" rel="nofollow"><span>Juridique</span></a></li>
    </ul>
    <section class="row center-xs gallery__list">
      ...
      <article class="col-md-4 col-sm-6 col-xs-12 col-custom gallery__wrapper <?php echo e($article->rubrique); ?>">
        <div class="gallery__item">
          <a href="/chiffres-utiles/<?php echo e($article->slug); ?>" rel="nofollow" class="row image" style="background-image: url('<?php echo e($article->image); ?>')">               
            <span class="article__category <?php echo e($article->rubrique); ?>"><?php echo e($article->rubrique); ?></span>
          </a>
          <div class="row article">
            <div class="col-xs-12">
              <h3 class="row article__title"><a href="/chiffres-utiles/<?php echo e($article->slug); ?>" rel="nofollow"><?php echo e($article->title); ?></a></h3>
            ...
            <div class="col-xs-12 article__footer">
                ...
                <a href="/chiffres-utiles/<?php echo e($article->slug); ?>" rel="nofollow" class="article__button">Lire +</a>
            </div>
          </div>
        </div>
      </article>
        ...
        <?php if($digitarticles->lastPage() > 1): ?>
          <ul class="pagination">
              <li class="<?php echo e(($digitarticles->currentPage() == 1) ? ' disabled' : ''); ?>">
                  <a href="<?php echo e($digitarticles->previousPageUrl()); ?>#gallery" rel="prev nofollow"><i class="material-icons">chevron_left</i></a>
               </li>
              <?php for($i = 1; $i <= $digitarticles->lastPage(); $i++): ?>
                  ...
                  <?php if($from < $i && $i < $to): ?>
                      <li class="<?php echo e(($digitarticles->currentPage() == $i) ? ' active' : ''); ?>">
                        ...
                        <?php else: ?>
                          <a href="<?php echo e($digitarticles->url($i)); ?>#gallery" rel="nofollow"><?php echo e($i); ?></a>
                        <?php endif; ?>
                      </li>
                  <?php endif; ?>
              <?php endfor; ?>
              <li class="<?php echo e(($digitarticles->currentPage() == $digitarticles->lastPage()) ? ' disabled' : ''); ?>">
                  <a href="<?php echo e($digitarticles->nextPageUrl()); ?>#gallery" rel="next nofollow"><i class="material-icons">chevron_right</i></a>
              </li>
          </ul>
      <?php endif; ?>
    </div>
