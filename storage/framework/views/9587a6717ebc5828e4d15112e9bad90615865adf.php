        ...
        <?php if($digitarticles->lastPage() > 1): ?>
          <ul class="pagination">
              <li class="<?php echo e(($digitarticles->currentPage() == 1) ? ' disabled' : ''); ?>">
                  <a href="<?php echo e($digitarticles->previousPageUrl()); ?>" rel="prev nofollow"><i class="material-icons">chevron_left</i></a>
               </li>
              <?php for($i = 1; $i <= $digitarticles->lastPage(); $i++): ?>
                  ...
                  <?php if($from < $i && $i < $to): ?>
                      <li class="<?php echo e(($digitarticles->currentPage() == $i) ? ' active' : ''); ?>">
                        ...
                        <?php else: ?>
                          <a href="<?php echo e($digitarticles->url($i)); ?>" rel="nofollow"><?php echo e($i); ?></a>
                        <?php endif; ?>
                      </li>
                  <?php endif; ?>
              <?php endfor; ?>
              <li class="<?php echo e(($digitarticles->currentPage() == $digitarticles->lastPage()) ? ' disabled' : ''); ?>">
                  <a href="<?php echo e($digitarticles->nextPageUrl()); ?>" rel="next nofollow"><i class="material-icons">chevron_right</i></a>
              </li>
          </ul>
      <?php endif; ?>
    </div>
