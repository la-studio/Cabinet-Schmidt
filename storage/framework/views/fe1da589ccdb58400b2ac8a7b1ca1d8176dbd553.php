      ...
      <div class="row center-xs echo-article__suggestions">
        ...
        <div class="col-md col-sm-6 col-xs-12 suggestion">
          <div class="row wrapper">
            <span class="col-xs-12 suggestion__cover"><a href="/actus/<?php echo e($suggestion->slug); ?>" style="background-image:url('<?php echo e($suggestion->image); ?>')"></a></span>
            <a href="/actus/<?php echo e($suggestion->slug); ?>" class="col-xs-12 suggestion__caption"><?php echo e($suggestion->title); ?></a>
          </div>
        </div>
        <?php endforeach; ?>
      </div>
