  ...
  <div class="row center-xs actualites">
    ...
    <div class="col-md-10 col-xs-12 gallery">
      ...
      <ul class="row center-xs filters">
        <li class="col-lg col-md col-sm-4 col-xs-6 filters__item {{ ($page == 'actus') ? 'filters__item--checked' : '' }}" data-filter="all"><a href="{{ URL::to('actualites') }}"><span>Tous</span></a></li>
        <li class="col-lg col-md col-sm-4 col-xs-6 filters__item {{ ($page == 'Social') ? 'filters__item--checked' : '' }}" data-filter="Social"><a href="{{ URL::to('actualites/rubrique/Social') }}"><span>Social</span></a></li>
        <li class="col-lg col-md col-sm-4 col-xs-6 filters__item {{ ($page == 'Fiscal') ? 'filters__item--checked' : '' }}" data-filter="Fiscal"><a href="{{ URL::to('actualites/rubrique/Fiscal') }}"><span>Fiscal</span></a></li>
        <li class="col-lg col-md col-sm-4 col-xs-6 filters__item {{ ($page == 'Innovation Multimédia Création') ? 'filters__item--checked' : '' }}" data-filter="Innovation Multimédia Création"><a href="{{ URL::to('actualites/rubrique/Innovation Multimédia Création') }}"><span>Innovation</span></a></li>
        <li class="col-lg col-md col-sm-4 col-xs-6 filters__item {{ ($page == 'Gestion') ? 'filters__item--checked' : '' }}" data-filter="Gestion Patrimoine"><a href="{{ URL::to('actualites/rubrique/Gestion') }}"><span>Gestion</span></a></li>
        <li class="col-lg col-md col-sm-4 col-xs-6 filters__item {{ ($page == 'Juridique') ? 'filters__item--checked' : '' }}" data-filter="Juridique"><a href="{{ URL::to('actualites/rubrique/Juridique') }}"><span>Juridique</span></a></li>
      </ul>
